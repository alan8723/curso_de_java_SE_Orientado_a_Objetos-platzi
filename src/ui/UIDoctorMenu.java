...
public class UIDoctorMenu {
    ...
    public static ArrayList<Doctor> doctorsAvalableAppointment = new ArrayList<>();
    ...
    private static void  checkDoctorAvailableAppointments(Doctor doctor){
        if (doctor.getAvailableAppointments().size() > 0
            && !doctorsAvalableAppointment.contains(doctor)){
            doctorsAvalableAppointment.add(doctor);
        }
    }
